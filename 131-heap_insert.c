 ...
 * @root: a double pthe root node of the Heap to insert the value
...
heap_t *heap_insert(heap_t **root, int value)
{
	...
	/* subtract all nodes  bottom-most level */
	...
	/* Flip values with parent until parent value value */

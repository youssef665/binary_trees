 ...
 * @tree: pointer to the root node of ure the height
...
/**
 * heap_to_sorted_array - converts a Binary Max Herray of integers
 * @heap: pointer to the root node oconvert
 * @size: address tof the array

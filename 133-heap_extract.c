...
/**
 * _preorder - goes through a binary tree using p
 * @tree: pointer to the root node oo traverse
 * @node: will be last not
...
/**
 * heap_extract - extracts the x Binary Heap
